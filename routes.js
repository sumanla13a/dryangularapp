...
var projects = require('./service/admin/projects');
...
exports = module.exports = function(app, passport) {
  ...
  // app.all('/api/user*', apiEnsureAccount);
  app.get('/api/user/:userId/projects', projects.find);
  app.post('/api/user/:userId/projects', projects.create);
